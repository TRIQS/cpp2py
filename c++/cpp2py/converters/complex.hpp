  ...
  template <> struct py_converter<std::complex<double>> {
    ...
    static bool is_convertible(PyObject *ob, bool raise_exception) {
      ...
      if (PyArray_CheckScalar(ob)) {
        ...
        if (PyArray_ISINTEGER((PyArrayObject *)(PyObject *)py_arr) or PyArray_ISFLOAT((PyArrayObject *)(PyObject *)py_arr) or PyArray_ISCOMPLEX((PyArrayObject *)(PyObject *)py_arr)) return true;
      }
